...
def accounts_pending(accounts, count=1, threshold=None, source=False, include_active=False):
    data = {}
...
def ledger(account, count, representative=False, weight=False, pending=False, modified_since=False, sorting=False):
    data = {}
    data['action'] = 'ledger'
    data['account'] = account
    data['count'] = count
